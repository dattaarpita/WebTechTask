...
include '../model/Model.php';
 ...
 if (empty($data["Cpass"])) 
   ...
   if (empty($data["nid"])) {
      ...
      if(empty($this-> error["nameError"]) && empty($this-> error["emailError"]) && empty($this-> error["nidError"]) && empty($this-> error["passError"]) && empty($this-> error["cpassError"]) && empty($this-> error["genderErr"])&& empty($this-> error["dobError"]))
      {
