...
<body class="bd">
    ...
    <legend>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;Account<hr></legend>
        ...
        ?></span>
                    ...
                    <input type="password" name="pass"onkeyup="return passVerification()" 
        onblur="return passVerification()"  class="form-control" id="pas" placeholder="Password" value="<?php echo $Password; ?>" class="form-control"
        ...
        onblur="return cpassVerification()"value="<?php echo $Password;?>" placeholder="Confirm Password" class="form-control"  data-toggle="tooltip" data-placement="top" 
        title="">
        ...
        <script>
            function myFunction1() {
                ...
                <input type="radio" id="m" name="gender" onclick="return genderVerification()"  value="Male" <?php if($Gender=="Male"){echo "checked";} ?>> Male&nbsp;
        <input type="radio" id="f" name="gender" onclick="return genderVerification()"value="Female" <?php if($Gender=="Female"){echo "checked";} ?>> Female&nbsp;
        <input type="radio" id="p" name="gender" onclick="return genderVerification()"value="Others" <?php if($Gender=="Others"){echo "checked";} ?>> Others&nbsp;
