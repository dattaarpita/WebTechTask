...
<body class="bd">
       ...
       <div style="display: flex;">
        ...
        <div>
         ...
         ?>
             ...
             <form onsubmit="return historyvalidation()"method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
             <label>Search by Payment System</label><br>
       <input type="text" name="keyword" id="keyword" value=""  onblur="return historyvalidation()" onkeyup="return historyvalidation()"        style="width: 25%;"> <br>
       <span id="payment_error" style="color: red;">
       </span><br>
       <span>
           <?php
            if($not_match!=""){
    ...
    if(y=="")
    {
        document.getElementById("payment_error").innerHTML="Search history is required";
        payment_error="Error";
        return false;
    }
    else{
